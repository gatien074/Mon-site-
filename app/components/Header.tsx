...
3.598-9 3.592h.125c-3.074.006-5.808-1.464-9-3.592c-12 0-10 14-10 14"
                />
                <path
                  fill="#9b9b9a"
      ...
      {/* <section className="flex h-96 mt-14 ">
        ...
        <div className=" bg-zinc-400 p-9 h-96 mt-20 ">
          ...
          <button
            className="bg-red-600 w-44 h-12 text-white border-2 rounded border-red-600 ml-10 mt-8 leading-3 relative right-10 top-7 hover:scale-105 translate-x-0.5 duration-75 hover:bg-black hover:border-black"
            type="button"
          >
            En savoir plus
          </button>
